      ...
      <div className="container grid lg:grid-cols-2 gap-10 items-center py-20 md:py-32">
        ...
        <div className="relative flex justify-center items-center mt-12 lg:mt-0">
          ...
          <div className="absolute top-20 -left-8 z-20">
            ...
            <div className="absolute bottom-[-7px] right-4 w-0 h-0 border-l-[8px] border-l-transparent border-r-[8px] border-r-transparent border-t-[8px] border-t-primary rotate-180"></div>
          </div>
